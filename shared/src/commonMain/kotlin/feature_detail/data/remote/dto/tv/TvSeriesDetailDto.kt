...
import feature_detail.data.remote.dto.credits.CreditsDto
import feature_detail.data.remote.dto.watchProvider.WatchProvidersDto
...
data class TvSeriesDetailDto(
    ...
    @SerialName("last_episode_to_air") val lastEpisodeToAirDto: EpisodeToAirDto?,
    val name: String?,
    @SerialName("next_episode_to_air") val nextEpisodeToAir: EpisodeToAirDto?,
